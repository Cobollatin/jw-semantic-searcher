...
terraform {
  ...
  required_providers {
    ...
    azurerm = {
      ...
      version = "3.109.0"           # The 'version' attribute locks the provider to version 3.94.0. This ensures consistency and predictability in deployments, as Terraform will use this specific version of the provider.
    }
